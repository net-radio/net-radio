...
namespace NetRadio.Devices.G3XDdc
{
    ...
    {
        private const string DLL = "G31DDCAPI.dll";
        ...
        [UsedImplicitly][ApiCall]
        public  NativeDelegates.GetMWFilter GetMwFilter {get;protected set;}
        [UsedImplicitly][ApiCall]
        ...
        [UsedImplicitly][ApiCall]
        public  NativeDelegates.SetMWFilter SetMwFilter {get;protected set;}
        [UsedImplicitly][ApiCall]
