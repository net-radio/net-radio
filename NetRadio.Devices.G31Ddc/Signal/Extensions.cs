...
namespace NetRadio.Devices.G3XDdc.Signal
{
    ...
    public static class Extensions
    {
        ...
        public static BinParameters BinParametersDetailed(this G31DdcRadio radio, uint channel)
        {
            uint index;
        ...
        public static int UsableDownSamples(this G31DdcRadio radio, int fftlength, int points)
        {
