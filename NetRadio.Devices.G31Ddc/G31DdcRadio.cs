...
{
    public class G31DdcRadio:Radio<G31DdcRadio>,IProviders<G31DdcRadio>
    {
        ...
        public G31DdcRadio LedMode(LedMode mode)
        {
        ...
        public G31DdcRadio Power(bool power)
        {
        ...
        public G31DdcRadio Attenuator(AttenuatorValue value)
        {
        ...
        {
            var res = false;
            Check(_api.GetMwFilter(GetHandle(), ref res));
            return res;
        }

        public G31DdcRadio MwFilter(bool state)
        {
            Check(_api.SetMwFilter(GetHandle(), state));
            return this;
        }

        public bool TryMwFilter(bool state)
        {
            return _api.SetMwFilter(GetHandle(), state);
        }
        ...
        public G31DdcRadio Dithering(bool state)
        {
        ...
        public G31DdcRadio AdcNoiseBlanker(bool active)
        {
        ...
        public G31DdcRadio AdcNoiseBlanker(ushort threshold)
        {
        ...
        public G31DdcRadio StartIf(ushort period)
        {
        ...
        public G31DdcRadio Inverted(bool active)
        {
        ...
        public G31DdcRadio AbsoluteFrequency(uint frequency, uint ddc2Channel)
        {
        ...
        public G31DdcRadio DrmKey(string path)
        {
        ...
        public IRadioInfoProvider<G31DdcRadio> InfoProvider()
        {
            return new G31DdcRadioInfoProvider();
        }

        public IRadioProvider<G31DdcRadio> RadioProvider()
        {
            return new G31DdcRadioProvider();
        }
        ...
        internal G31DdcRadio(IntPtr handle)
            :this()
        {
            Handle = handle;
            CachedInfo = Info();
