namespace NetRadio.Devices.G313
{
    ...
    public class G313RadioLimits
    {
        ...
        {
            return value > _radio.CachedInfo.MaxFrequency
                ? (uint) _radio.CachedInfo.MaxFrequency
                : value < _radio.CachedInfo.MinFrequency ? (uint) _radio.CachedInfo.MinFrequency : value;
        }
        /// <summary>
